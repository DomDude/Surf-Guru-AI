...
- [ ] **1A.1 Rotate the leaked Gemini API key** [S, blocks 1A.2]
...
- [ ] **1A.2 Lock down env files** [P, after 1A.1]
...
- [ ] **1A.3 Fix `layout.tsx` metadata** [P]
...
- [ ] **1A.4 Rewrite `webapp/README.md`** [P]
...
- [ ] **1A.5 Clean empty dirs and stray files** [P]
...
- [ ] **1A.6 Sync `task_plan.md` with `progress.md`** [P]
